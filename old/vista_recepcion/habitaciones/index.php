...
<head>
  ...
  <title>CCP Suites | Habitaciones</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pagina de Habitaciones</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <br/>
                <a name="" id="" class="btn btn-primary" href="crear.php" role="button">Nueva tarea +</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Dpto. De Sistemas</td>
                      <td>Instalacion</td>
                      <td>Huesped de la P1N05</td>
                      <td>Media</td>
                      <td>05/10/2023</td>
