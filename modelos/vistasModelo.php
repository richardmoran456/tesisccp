...
class vistasModelo
{
    ...
    {
        $listaBlanca = ["home", "usuarios", "usuario-create", "usuario-update", "solicitudes", "tareas", "huespedes", "pisos", "habitaciones", "notificaciones", "perfil", "departamentos", "departamento-create", "departamento-update", "puestos", "puesto-create", "puesto-update", "eventos", "empleados", "empleado-create", "empleado-update", "alas","ala-create","ala-update", "equipos","equipo-create", "equipo-update", "modulos", "modulo-update"];
