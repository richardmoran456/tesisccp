...
class vistasModelo
{
    ...
    {
        $listaBlanca = ["home", "usuarios", "usuario-create", "usuario-update", "solicitudes", "solicitud-create", "solicitud", "solicitud-update", "tareas", "huespedes", "pisos", "habitaciones", "notificaciones", "perfil", "departamentos", "departamento-create", "departamento-update", "puestos", "puesto-create", "puesto-update", "eventos", "empleados", "empleado-create", "empleado-update", "alas", "ala-create", "ala-update", "equipos", "modulos", "modulo-update"];
