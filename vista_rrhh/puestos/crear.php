...
if ($_POST) {
  ...
  $stmt = $conexion->prepare("INSERT INTO puestos(nombredelpuesto) VALUES (?)");
  $stmt->bind_param("s", $nombredelpuesto);
  $stmt->execute();
}
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nombredelpuesto" id="nombredelpuesto"
              aria-describedby="helpId" placeholder="nombredelpuesto">
          </div>
